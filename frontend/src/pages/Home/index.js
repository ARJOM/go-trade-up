    ...
    <div>
            <div className="background1">
                <section className="text1">
                    ...
                    <p>Consulte os produtos dos comerciantes aqui cadastrados, adicione-os à sua lista de compras e envie o seu pedido personalizado. <br />
            ...
            <div className="optionsHome">  
                <div className="background2">
                    <section className="text2">
                        <p>Cadastre-se como comerciante e venda seus produtos e serviços aqui.</p>
                    </section>
                </div>

                <div className="background3">
                    <section className="text3">
                        <p>No ato da compra ou de maneira isolada, faça doações e contribua com Instituições Parceiras.</p>
                    </section>
                </div>
            </div>
            ...
            <div className="background5">
                <section className="text5">
                    <h1><darker>SOBRE NÓS</darker></h1>
                    <p>Sejam Bem Vindos ao GoTradeUp.</p>
                    ...
                    <p>Além de conectar comerciantes locais com seus clientes em potencial de uma forma rápida e segura, seguindo a linha de fornecimento por delivery, em alta em tempos de quarentena, a palataforma estimula a realização de doações, direcionadas a Insitutos Sociais locais ou ONGs da escolha do usuário!</p>
                    <p>Fomente o comércio local e ajude os grupos mais vulneráveis a se reerguerem!</p>
                </section>
            </div>
        </div>
    </div>
